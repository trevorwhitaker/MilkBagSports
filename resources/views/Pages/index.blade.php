...
@if ($week != 1)
    <div class="previouspage_button"><a href="/week/{{$week - 1 }}" class="btn btn-primary">Previous Week</a></div>
@endif

@if ($flag)
    <div class="nextpage_button"><a href="/week/{{ $week + 1 }}" class="btn btn-primary">Next Week</a></div>
@endif
